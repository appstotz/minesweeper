...
void main() {
  group('test Game', () {
    test('test game state', () async {
      ...
      var boardPlaying = [[bombHidden, emptyHidden],[emptyRevealed, emptyHidden]];
      var gamePlaying = Game(boardPlaying);
      expect(gamePlaying.gameState, GameState.running);

      var boardWin = [[bombHidden, bombHidden],[emptyRevealed, emptyRevealed]];
      var gameWin = Game(boardWin);
      expect(gameWin.gameState, GameState.win);

      var boardLost = [[bombRevealed, bombHidden],[emptyRevealed, emptyHidden]];
